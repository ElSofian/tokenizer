...
- Les outils disponibles (Remix, Hardhat, Etherscan) sont stables et bien documentés, c'est également un peu les outils de base
...
## Structure
- `code/` : contient le smart contract Solidity qui etablit les règles et fonctionnalités du token
